        ...
        <div className="flex flex-wrap -m-12">
          <div className="p-12 md:w-1/2 flex flex-col items-start">
            ...
            <p className="leading-relaxed mb-8">
              ...
              chambray 90&apos;s, slow-carb etsy turmeric. Cray pug you probably
              haven&apos;t heard of them hexagon kickstarter craft beer pork
              chic.
            </p>
          ...
          <div className="p-12 md:w-1/2 flex flex-col items-start">
            ...
            <p className="leading-relaxed mb-8">
              ...
              portland. VHS man braid palo santo hoodie brunch trust fund.
              Bitters hashtag waistcoat fashion axe chia unicorn. Plaid fixie
              chambray 90&apos;s, slow-carb etsy turmeric.
            </p>
            <div className="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 mt-auto w-full">
              <a href="#" className="text-indigo-500 inline-flex items-center">
                Learn More
